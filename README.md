...
Install it: `go get github.com/jegarberi/go-zabbix-api`
...
import (
	...
	"github.com/jegarberi/go-zabbix-api"
)
...
Documentation is available on [godoc.org](https://godoc.org/github.com/jegarberi/go-zabbix-api).
